...
import { collection, getDocs, addDoc, doc, getDoc, query, where } from "https://www.gstatic.com/firebasejs/12.19.0/firebase-firestore.js";
...
const WatermarkManager = {
    ...
    createOverlay: function(nama, nis) {
        ...
        ctx.fillText(`CBT TRIGUNA 1956`, 0, 25);
